...
namespace GenericApi.Model.Migrations
{
    ...
    [Migration("20210727232909_WorkShop")]
            ...
            modelBuilder.Entity("GenericApi.Model.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 7, 27, 23, 29, 8, 355, DateTimeKind.Unspecified).AddTicks(9956), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = false,
                            Dob = new DateTime(2021, 7, 28, 1, 29, 8, 356, DateTimeKind.Local).AddTicks(781),
                            DocumentType = 0,
